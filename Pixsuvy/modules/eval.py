...
@Client.on_message(filters.command("eval", CMD_HANDLER) & filters.me)
...
@Client.on_message(filters.command("exec", CMD_HANDLER) & filters.me)
async def terminal(Client, message):
    if len(message.text.split()) == 1:
        await message.edit(f"Usage: `{CMD_HANDLER}exec echo owo`")
        return
...
add_command_help(
    "exec",
    [
        ["exec", "To Execute terminal commands in a subprocess."],
    ],
)
