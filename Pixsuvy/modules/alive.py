...
from Pixsuvy import CMD_HELP, StartTime
from Pixsuvy.helpers.basic import edit_or_reply
from Pixsuvy.helpers.PyroHelpers import ReplyCheck
from Pixsuvy.helpers.SQL.globals import gvarstatus
from Pixsuvy.helpers.tools import convert_to_image
from Pixsuvy.utils import get_readable_time
...
async def setalivelogo(client: Client, message: Message):
    try:
        import Pixsuvy.helpers.SQL.globals as sql
