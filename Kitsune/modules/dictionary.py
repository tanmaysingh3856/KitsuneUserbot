...
from Kitsune.helpers.aiohttp_helper import AioHttp

from .help import add_command_help


@Client.on_message(filters.command(["define", "dict"], cmd) & filters.me)
async def define(bot: Client, message: Message):
    ...
    if not input_string:
        await message.edit("`Plz enter word to search`")
    else:
        word = input_string
...
add_command_help(
    "dictionary",
    [
        [f"define or {cmd}dict", "Define the word you send or reply to."],
    ],
)
