...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("Kitsune").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("Kitsune").info(f"Invalid Git Command")
        ...
        LOGGER("Kitsune").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("Kitsune").info(f"Heroku App Configured")
